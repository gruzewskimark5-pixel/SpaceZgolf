...
export default function SimulationDashboard() {
  ...
  return (
    <div className="p-8 grid gap-8 min-h-screen bg-[#0a0a0a] text-slate-200">
      ...
      {/* Heat Engine v1 Top Force Events Panel */}
      <Card className="bg-[#121212] border-amber-500/50 shadow-xl overflow-hidden shadow-amber-900/20">
         <div className="bg-amber-900/20 p-4 border-b border-amber-900/50 flex justify-between items-center">
             <h2 className="text-xl font-semibold text-amber-500 flex items-center gap-2">
                 ...
                 Season 0: Canonical Top Force Events
             </h2>
         </div>
